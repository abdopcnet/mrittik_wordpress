...
/** Database password */
define( 'DB_PASSWORD', '0ZgKoGwg1Merh' );
 ...
 * 
 * These settings enable WordPress to work properly behind Cloudflare Tunnel
 */

// Trust Cloudflare proxy (detect real visitor IP)
if (isset($_SERVER['HTTP_CF_CONNECTING_IP'])) {
    $_SERVER['REMOTE_ADDR'] = $_SERVER['HTTP_CF_CONNECTING_IP'];
}

// Enable HTTPS detection when behind Cloudflare proxy
