...
class Mrittik_Breadcrumb
{
    ...
    function __construct( $args = array() )
    {
        $args = wp_parse_args( $args, array(
            'home_label'            => get_the_title( get_option( 'page_on_front' ) ),
            '404_label'             => esc_html__( 'Not Found', 'mrittik' ),
            'search_results_label'  => esc_html__( 'Search Results', 'mrittik' ),
    ...
    function add_tag_entry()
    {
        ...
        $this->add_entry(
            esc_html__( 'Tag:', 'mrittik' ).' '.single_tag_title( '', false ) ).' '.get_tag_link( $queried_object->term_id
        );
    }
    ...
    function add_author_entry()
    {
        ...
        $this->add_entry(
            esc_html__( 'Author:', 'mrittik' ).' '.$userdata->display_name
        );
    }
    ...
    function add_tax_entry()
    {
         ...
         */
        $entries = apply_filters( 'mrittik_breadcrumb_taxonomy', $entries, $this_term );
    ...
    function add_paged_entry()
    {
        ...
        {
            $this->add_entry(
                apply_filters( 'mrittik_breadcrumb_paged', sprintf( 'Page %s', $page ) ),
                ''
            );
        }
    }
    ...
    function add_single_ancestor_entry( $post )
    {
         ...
         */
        $entries = apply_filters( 'mrittik_breadcrumb_single', $entries, $post );
