...
if (!class_exists('Mrittik_Main')) {
    class Mrittik_Main extends Mrittik_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Mrittik_Main();
            }
        ...
        public function get_sidebar_args($args = []){
            ...
            $sidebars = ['content_class' => 'col-xl-9 col-lg-8', 'sidebar_class' => 'col-xl-3 col-lg-4', 'wrap_class' => 'pxl-content-wrap'];
            ...
            if ($sidebar_pos === '0' || $sidebar_pos === 'none' || $sidebar_pos === '' || !$sidebar_active) {
                ...
                $sidebar_class_xl = 12 - (int)$args['content_col_xl'];
                $sidebar_class_lg = 12 - (int)$args['content_col_lg'];
                $sidebars['wrap_class'] = 'pxl-content-wrap pxl-has-sidebar pxl-sidebar-'.$sidebar_pos;
                $sidebars['content_class'] = 'pxl-content-area pxl-content-'.$args['type'].' col-12 col-xl-'.$args['content_col_xl'].' col-lg-'.$args['content_col_lg'];
                $sidebars['sidebar_class'] = 'pxl-sidebar-area pxl-sidebar-'.$args['type'].' col-12 col-xl-'.$sidebar_class_xl.' col-lg-'.$sidebar_class_lg;
            }
...
function mrittik() {
    return Mrittik_Main::getInstance();
}
// Install
mrittik();
