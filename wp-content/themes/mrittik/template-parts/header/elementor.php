<?php
$logo_m = mrittik()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo-light.png', 'id' => '' ] );
$logo_m_dark = mrittik()->get_theme_opt( 'logo_m_dark', ['url' => get_template_directory_uri().'/assets/img/logo-dark.png', 'id' => '' ] );
$p_menu = mrittik()->get_page_opt('p_menu');
$pm_menu = mrittik()->get_page_opt('pm_menu');
$sticky_scroll = mrittik()->get_theme_opt('sticky_scroll');
$header_layout = mrittik()->get_opt('header_layout');
...
<header id="pxl-header-elementor" class="is-sticky">
    ...
    <?php elseif ($disable_header_mobile_layout === '0') : ?>
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu" data-lenis-prevent>
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php mrittik_header_mobile_search_form(); ?>
