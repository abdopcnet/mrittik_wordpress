...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Video Player', 'mrittik' ),
        'icon' => 'eicon-play',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Style', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style 1',
                                'style2' => 'Style 2',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'p-center' => 'Center',
                                'p-top-left' => 'Top Left',
                        ...
                        array(
                            'name' => 'top_position',
                            'label' => esc_html__('Top Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                        ...
                        array(
                            'name' => 'right_position',
                            'label' => esc_html__('Right Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'control_type' => 'responsive',
                            'default' => [
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'icon_width',
                            'label' => esc_html__('Icon Width (px)', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => ['px'],
                            'range' => [
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'bg_position',
                            'label' => esc_html__( 'Background Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'responsive' => true,
                            'options' => [
                                '' => esc_html__( 'Default', 'mrittik' ),
                                'center center' => esc_html__( 'Center Center', 'mrittik' ),
                                'center left' => esc_html__( 'Center Left', 'mrittik' ),
                                'center right' => esc_html__( 'Center Right', 'mrittik' ),
                                'top center' => esc_html__( 'Top Center', 'mrittik' ),
                                'top left' => esc_html__( 'Top Left', 'mrittik' ),
                                'top right' => esc_html__( 'Top Right', 'mrittik' ),
                                'bottom center' => esc_html__( 'Bottom Center', 'mrittik' ),
                                'bottom left' => esc_html__( 'Bottom Left', 'mrittik' ),
                                'bottom right' => esc_html__( 'Bottom Right', 'mrittik' ),
                                'initial' => esc_html__( 'Custom', 'mrittik' ),
                            ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'X Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'responsive' => true,
                            'size_units' => [ 'px', 'em', '%', 'vw' ],
                            'default' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Y Position', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'responsive' => true,
                            'size_units' => [ 'px', 'em', '%', 'vw' ],
                            'default' => [
                        ...
                        array(
                            'name' => 'bg_attachment',
                            'label' => esc_html__( 'Background Attachment', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'options' => [
                                '' => esc_html__( 'Default', 'mrittik' ),
                                'scroll' => esc_html__( 'Scroll', 'mrittik' ),
                                'fixed' => esc_html__( 'Fixed', 'mrittik' ),
                            ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'raw' => esc_html__( 'Note: Attachment Fixed works only on desktop.', 'mrittik' ),
                            'separator' => 'none',
                            'condition' => [
                                'image_type' => 'bg',
                                'bg_attachment' => 'fixed',
                        ...
                        array(
                            'name' => 'bg_repeat',
                            'label' => esc_html__( 'Background Repeat', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'responsive' => true,
                            'options' => [
                                '' => esc_html__( 'Default', 'mrittik' ),
                                'no-repeat' => esc_html__( 'No-repeat', 'mrittik' ),
                                'repeat' => esc_html__( 'Repeat', 'mrittik' ),
                                'repeat-x' => esc_html__( 'Repeat-x', 'mrittik' ),
                                'repeat-y' => esc_html__( 'Repeat-y', 'mrittik' ),
                            ],
                            'selectors' => [
                        ...
                        array(
                            'name' => 'bg_size',
                            'label' => esc_html__( 'Background Size', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'responsive' => true,
                            'options' => [
                                '' => esc_html__( 'Default', 'mrittik' ),
                                'auto' => esc_html__( 'Auto', 'mrittik' ),
                        ...
                        array(
                            'name' => 'bg_width',
                            'label' => esc_html__( 'Background Width', 'mrittik' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'responsive' => true,
                            'size_units' => [ 'px', 'em', '%', 'vw' ],
                            'range' => [
