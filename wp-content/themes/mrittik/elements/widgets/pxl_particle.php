...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_particle',
        'title' => esc_html__('BR Particle', 'mrittik' ),
        'icon' => 'eicon-barcode',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'images',
                            'label' => esc_html__('Images', 'mrittik'),
                            'type' => \Elementor\Controls_Manager::REPEATER,
                            'default' => [],
                            'controls' => array(
                                array(
                                    'name' => 'pxl_icon_light',
                                    'label' => esc_html__('SVG Light', 'mrittik' ),
                                    'type' => \Elementor\Controls_Manager::ICONS,
                                    'fa4compatibility' => 'icon',
                                    'condition' => [
                                        'particle_effect' => 'slide-draw-svg',
                                    ],
                                ),
                                array(
                                    'name' => 'pxl_icon_dark',
                                    'label' => esc_html__('SVG Dark', 'mrittik' ),
                                    'type' => \Elementor\Controls_Manager::ICONS,
                                    'fa4compatibility' => 'icon',
                                    'condition' => [
                                        'particle_effect' => 'slide-draw-svg',
                                ...
                                array(
                                    ...
                                    'options' => [
                                        ...
                                        'slide-draw-svg' => 'Draw SVG',
                                    ],
                                ),
                                array(
                                    'name' => 'transform_hover',
                                    'label' => esc_html__('Transform Hover', 'mrittik' ),
                                    'type' => \Elementor\Controls_Manager::SELECT,
                                    'default' => '',
                                    'options' => [
                                        '' => 'None',
                                ...
                                array(
                                    'name' => 'parallax_move',
                                    'label' => esc_html__('Parallax Move', 'mrittik' ),
                                ...
                                array(
                                    'name' => 'pxl_animate',
                                    'label' => esc_html__('Animate', 'mrittik' ),
                                    'type' => \Elementor\Controls_Manager::SELECT,
                                ...
                                array(
                                    'name' => 'z-index',
                                    'label' => esc_html__('Z-Index', 'mrittik' ),
