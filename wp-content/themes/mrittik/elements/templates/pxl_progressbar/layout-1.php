        ...
        <?php foreach ($progressbar_list as $key => $value):
            ...
            <div class="pxl--item">
                <div class="pxl--meta">
                    ...
                    <?php } ?>
                     <span class="pxl--percentage pxl--counter-value" data-duration="2000" data-to-value="<?php echo pxl_print_html($value['percent']['size']); ?>">0</span>
                </div>
                <div class="pxl--holder">
                    <div <?php pxl_print_html($widget->get_render_attribute_string( $progress_bar_key )); ?>></div>
                    <div class="pxl--background"></div>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
