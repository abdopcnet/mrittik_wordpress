...
$space_between = $widget->get_setting('space_between');
$opts = [
...
if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="pxl-swiper-sliders pxl-testimonial-carousel pxl-testimonial-carousel1 pxl-swiper-arrow-show pxl-parent-transition pxl-parent-cursor pxl-drag-area <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'mrittik' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>" style="--data-speed: <?php echo esc_attr($speed .'ms'); ?>">
        <div class="pxl-carousel-inner">
            <div class="pxl-image-bg bg-image-left" data-parallax='{"x": -100}' style="background-image: url(<?php echo esc_url($settings['image_first']['url']); ?>);"></div>
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' ));?>>
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($settings['testimonial'] as $key => $value):
                        $desc = isset($value['desc']) ? $value['desc'] : '';
                        $sub_text = isset($value['sub_text']) ? $value['sub_text'] : '';
                        ?>
            ...
            <div class="pxl-image-bg bg-image-right" data-parallax='{"x": 100}' style="background-image: url(<?php echo esc_url($settings['image_second']['url']); ?>);"></div>
            <?php if($arrows == 'true'): ?>
