...
<div id="<?php echo esc_attr($html_id) ?>" class="pxl-grid pxl-portfolio-grid-layout2 pxl-check-scroll <?php echo esc_attr($settings['scroll_effect']); ?>" data-layout="<?php echo esc_attr($layout_mode); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
