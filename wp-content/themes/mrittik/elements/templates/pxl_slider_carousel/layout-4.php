...
if(isset($settings['slider1']) && !empty($settings['slider1']) && count($settings['slider1'])): ?>
    <div class="pxl-swiper-sliders pxl-slider-carousel pxl-slider-carousel4 pxl-drag-area pxl-parent-transition pxl-parent-cursor pxl-swiper-arrow-show <?php echo esc_attr($settings['carousel_style']); ?> <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'mrittik' ); } ?> <?php if($settings['carousel_style'] == 'style2') { echo esc_attr__( 'pxl-slider-no-parallax', 'mrittik' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>">
                    ...
                    <?php foreach ($settings['slider1'] as $key => $value):
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" data-wow-duration="<?php echo esc_attr($settings['pxl_animate_duration']); ?>s">
                                <div class="pxl-item--content">
                                    <div class="content--inner">
                                        <div class="content--wrapper" <?php if($settings['carousel_style'] == 'style1') { ?>data-parallax='{"x": 50}'<?php } ?>>
                                            <?php if(!empty($title)) : ?>
                                ...
                                <?php if($settings['show_grid_line'] == 'true') : ?>
                                    <div class="pxl-grid-lines <?php if($settings['show_grid_mobile'] == 'true') { echo esc_attr__( 'grid-mobile', 'mrittik' ); } ?>">
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                        <span></span>
                            ...
                            <?php if(!empty($image_light['id'])) : ?>
                               <div class="mask--content img-light" style="background-image: url(<?php echo esc_url($image_light['url']); ?>);"></div>
                            <?php endif; ?>
                            <?php if(!empty($image_dark['id'])) : ?>
                               <div class="mask--content img-dark" style="background-image: url(<?php echo esc_url($image_dark['url']); ?>);"></div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                </div>
