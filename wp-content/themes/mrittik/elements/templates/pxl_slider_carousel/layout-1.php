...
if(isset($settings['slider1']) && !empty($settings['slider1']) && count($settings['slider1'])): ?>
    <div class="pxl-swiper-sliders pxl-slider-carousel pxl-slider-carousel1 pxl-parent-transition pxl-swiper-arrow-show pxl-parent-cursor pxl-drag-area <?php echo esc_attr($settings['carousel_style']); ?> <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'mrittik' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>">
                ...
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($settings['slider1'] as $key => $value):
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php if($settings['zoom_effect'] != 'none') { echo esc_attr('pxl-img-zoompan', 'mrittik'); } ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" data-wow-duration="<?php echo esc_attr($settings['pxl_animate_duration']); ?>s">
                                <div class="pxl-item--image">
                                    <?php if(!empty($image_light['id'])) : ?>
                                       <div class="item--image img-light" style="background-image: url(<?php echo esc_url($image_light['url']); ?>);" data-scale="<?php echo esc_attr($settings['zoom_effect']); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(!empty($image_dark['id'])) : ?>
                                       <div class="item--image img-dark" style="background-image: url(<?php echo esc_url($image_dark['url']); ?>);" data-scale="<?php echo esc_attr($settings['zoom_effect']); ?>"></div>
                                    <?php endif; ?>
                                </div>
