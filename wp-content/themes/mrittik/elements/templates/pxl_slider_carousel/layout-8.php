...
if(isset($settings['slider1']) && !empty($settings['slider1']) && count($settings['slider1'])): ?>
    <div class="pxl-swiper-sliders pxl-slider-carousel pxl-slider-carousel8 pxl-drag-area pxl-parent-transition pxl-parent-cursor pxl-swiper-arrow-show <?php if($arrows == 'true') { echo esc_attr__( 'pxl-show-arrow', 'mrittik' ); } ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>">
                                            ...
                                            <div class="content--wrapper">
                                                ...
                                                <div class="pxl-item--link">
                                                    <?php if ( !empty( $link['url'] ) ) { ?>
                                                        <a class="item--button btn-border-running" <?php echo implode( ' ', [ $link_attributes ] ); ?>>
                                                            <span class="btn-text">
