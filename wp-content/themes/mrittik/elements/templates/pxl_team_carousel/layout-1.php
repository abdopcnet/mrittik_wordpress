...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): ?>
    <div class="pxl-swiper-sliders pxl-team pxl-team-carousel1 pxl-parent-cursor pxl-drag-area <?php if($pagination !== 'false') { echo pxl_print_html('slide-swiper-dots', 'mrittik'); } ?> <?php echo esc_attr($settings['style']); ?> <?php if($center == 'true') { echo 'pxl--swiper-center'; } ?>">
